...
void main() {
  ...
  float height = snoise(vec2(uv.x * 1.5 + uTime * 0.08, uTime * 0.15)) * 0.4 * uAmplitude;
  height += snoise(vec2(uv.x * 3.0 + uTime * 0.12, uTime * 0.2)) * 0.2 * uAmplitude;
  height = exp(height);
  height = (uv.y * 2.0 - height + 0.15);
